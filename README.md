...
*ps：我本身是芯片设计小白，希望拓展自己的能力边界。*

额外挑战：探索**在哪些环节、怎样**将**AI人工智能**应用到这些**芯片**研发过程。

*ps：我相信专业的团队肯定早已经有所涉及了，我出于好奇，想探索AI的更大边界。*

进阶挑战：把**额外挑战**部分发掘的*需求*生产出小工具小产品。

# ysyx学习主页

[ysyx官方的课程主页](https://ysyx.oscc.cc/docs/)
...
课程对应的[讲义链接](https://ysyx.oscc.cc/docs/2306/preliminary/0.1.html)在课程主页这里。
